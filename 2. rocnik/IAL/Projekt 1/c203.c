...
/*
** funkce dostane parametr NULL -> queueError;
** vsechny prvky v poli nastavit na *;
** nastaveni indexu na nulu;
*/
...
/*
** ukazuji na stejny prvek -> fronta je prazdna;
*/
...
/*
** jestli se shoduji, je fronta plna;
*/
...
/*
** pokud je fronta prazdna -> Error;
** jinak na c dam hodnotu prvniho prvku pole (f_index = prvni prvek);
*/
...
/*
** pokud je fronta prazdna -> Error;
** jinak odstranim prvni znak ze zacatku fronty pomoci f_index (posun);
*/
...
/*
** pokud je fronta prazdna -> Error;
** jinak pomoci drive vytvorenych fci ulozim na c prvni znak fronty a odstranim jej z nej;
*/
...
/*
** pokud je fronta plna -> Error;
** jinak ulozim do pole znak c;
** posunu prvniho volneho prvku pomoci nextIndex;
*/
